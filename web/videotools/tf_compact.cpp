...
static av_cold int compact_init(AVTextFormatContext *wctx) {
  CompactContext *compact = (CompactContext *)wctx->priv;
...
static void compact_print_str(AVTextFormatContext *wctx, const char *key,
                              const char *value) {
  CompactContext *compact = (CompactContext *)wctx->priv;
  AVBPrint buf;
...
static void compact_print_int(AVTextFormatContext *wctx, const char *key,
                              int64_t value) {
  CompactContext *compact = (CompactContext *)wctx->priv;
