...
static void ini_print_section_header(AVTextFormatContext *wctx,
                                     const void *data) {
  INIContext *ini = (INIContext *)wctx->priv;
...
static void ini_print_str(AVTextFormatContext *wctx, const char *key,
                          const char *value) {
  AVBPrint buf;
...
static void ini_print_int(AVTextFormatContext *wctx, const char *key,
                          int64_t value) {
